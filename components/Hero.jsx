      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            <motion.h1 variants={item} className="mt-2 text-4xl sm:text-5xl lg:text-6xl font-heading font-extrabold leading-tight">
            ...
            <motion.p variants={item} className="mt-4 max-w-xl muted">
          ...
          <motion.div variants={item} className="flex items-center justify-center lg:justify-end">
            <div className="hexagon">
              <Image src="/images/image.png" alt="Subham Kumar" fill className="object-cover" priority />
            </div>
          </motion.div>
        </motion.div>
      </div>
